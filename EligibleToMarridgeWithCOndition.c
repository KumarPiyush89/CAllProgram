...
int main()
{
	...
	{
		if(ry>=21)
		printf("\n congrats!!!! mr.,You Have eligible to marriage.");
		else
		printf("\n SOrry!!! mr.,You have not eligible to marriage bcz you are only %d",ry);
	...
	else if(gender==2)
	{
		...
		if(ry>=18)
		printf("\n congrats!!!! miss.,You Have eligible to marriage.");
		else
		printf("\n SOrry!!! miss.,You have not eligible to marriage bcz you are only %d",ry);
		
    }
    else
    {
    	printf("\nOOPs! you hav entered an invalid gender value.");
	}
